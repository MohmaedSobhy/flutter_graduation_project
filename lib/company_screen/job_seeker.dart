                ...
                Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      padding: const EdgeInsets.only(bottom: 20,top:650,left:270),
                      child: Container(
                        ...
                        Text('Reject',style: TextStyle(color: Color.fromRGBO(255, 255, 255, 1),fontSize: 20),)),
                      ),
                    ),
                  ],
                ),
                  Padding(
                  padding: const EdgeInsets.only(bottom: 20,top:650,left: 10),
                  child: Container(
                    height: 50,
                    width: 100,
                 ...
                 Padding(
                  padding: const EdgeInsets.only(bottom: 20,top:650,left: 135),
                  child: Container(
                    height: 50,
                    width: 100,
                    ...
                    child: Center(child: Text('Wait',style: TextStyle(color: Colors.white,fontSize: 20),)),
                  ),
                ),
                Container(
                  height: 200,
